...
def parse_config():
    ...
    parser.add_argument('--ckpt', type=str, default="/home/ailab/git/Team_3/baseline_code_and_model/03_3D객체검출차량용/02_baseline_code_and_model/output/waymo_models/dsvt_voxel_label_3/default/ckpt/checkpoint_epoch_18.pth", help='specify the pretrained model')
