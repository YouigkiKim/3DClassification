...
class CustomAvDataset(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train'):
        ...
        database_save_path = Path(self.root_path) / ('Team_3_label2_augmentation_gt_database' if split == 'train' else ('Team_3_label2_augmentation_gt_database_%s' % split))
        db_info_save_path = Path(self.root_path) / ('Team_3_label_augmentation_dbinfos_%s.pkl' % split)
...
def create_custom_av_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    train_filename = save_path / ('Team_3_label_augmentation_%s.pkl' % train_split)
    val_filename = save_path / ('Team_3_label_augmentation_%s.pkl' % val_split)
