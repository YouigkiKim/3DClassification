...
class CustomAvDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        split_dir = os.path.join(self.root_path, 'ImageSets_Team_1', (self.split + '.txt'))
    ...
    def set_split(self, split):
        ...
        split_dir = self.root_path / 'ImageSets_Team_1' / (self.split + '.txt')
...
def create_custom_av_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    train_split, val_split = 'train_all', 'val'
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_av_infos':
        ...
        create_custom_av_infos(
            ...
            data_path="/home/ailab/git/Team_1/baseline_code_and_model/3D_detection_car/02_baseline_code_and_model/data/custom_av",
            save_path="/home/ailab/git/Team_1/baseline_code_and_model/3D_detection_car/02_baseline_code_and_model/data/custom_av",
        )
