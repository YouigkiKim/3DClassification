...
def get_pooling_index(coors, sparse_shape, window_shape):
    ...
    win_coors_x = torch.div(coors_x, win_shape_x, rounding_mode='trunc')
    win_coors_y = torch.div(coors_y, win_shape_y, rounding_mode='trunc')
    win_coors_z = torch.div(coors_z, win_shape_z, rounding_mode='trunc')
